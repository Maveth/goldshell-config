...
def parse_plan(plan: str) -> tuple[str, str, int, int, str | None]:
    # mhz/mv/pv kept as raw strings (not int/float) so we round-trip exactly
    # what the unit sent us, e.g. "0.41" volts or an integer "9100".
    # PV segment is optional: the HS Box omits it entirely.
    m = re.match(
